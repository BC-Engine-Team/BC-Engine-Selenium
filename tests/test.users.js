...
describe("S2 - Users", () => {
    ...
    describe("S2.3 - Admin wants to update an user", () => {
        ...
        it("S2.3.1 - Successfully updated an user", async () => {
            ...
            let tableDatas = await driver.findElement(By.xpath("/html/body/div/div/div/div/div[1]/div/div/table/tbody/tr[1]/td[4]"));
            assert.equal(await tableDatas.getText(), "admin");
            ...
            submitButton = await driver.findElement(By.xpath("/html/body/div/div/div/div/div[2]/div/div/form/div[5]/button[1]"));
            await driver.wait(until.elementIsEnabled(submitButton), 2000);
